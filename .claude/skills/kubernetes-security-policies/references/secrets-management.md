...
SEALED_SECRETS_MANIFEST_URL="https://github.com/bitnami-labs/sealed-secrets/releases/download/${SEALED_SECRETS_VERSION}/controller.yaml"

# Do NOT apply directly from a URL. Download, review, and verify first.
curl -fsSL "$SEALED_SECRETS_MANIFEST_URL" -o /tmp/sealed-secrets-controller.yaml
less /tmp/sealed-secrets-controller.yaml
sha256sum /tmp/sealed-secrets-controller.yaml

# Apply only after validation
kubectl apply -f /tmp/sealed-secrets-controller.yaml
