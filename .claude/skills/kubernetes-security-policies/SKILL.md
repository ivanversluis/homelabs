...
- Do not execute manifests/scripts directly from remote URLs.
- Use pinned versions/commits, download locally, review content, and verify integrity/provenance first.
- Apply only local files after validation.
